...
{
    public partial class ucDashBoard_DepartmentWithTAT : UserControl
    {
        ...
        public ucDashBoard_DepartmentWithTAT()
        {
            InitializeComponent();
        }
        ...
        {
            ucDashBoard_Department1.SetDataSource = null;
            if (XemTATTheoBoPhan)
            {
                ...
                if (data != null)
                {
                    if (data.Rows.Count > 0)
                    {
                        ...
                        ucDashBoard_Department1.TenBoPhan = tenBoPhan;
                        ucDashBoard_Department1.MaBoPhan = maBophan;
                        ucDashBoard_Department1.SetDataSource = data;
        ...
        private void ucDashBoard_DepartmentWithTAT_Load(object sender, EventArgs e)
        {
