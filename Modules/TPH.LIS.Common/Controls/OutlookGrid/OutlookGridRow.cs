    ...
    public class OutlookGridRow : DataGridViewRow
    {
        ...
        protected override void Paint(System.Drawing.Graphics graphics, System.Drawing.Rectangle clipBounds, System.Drawing.Rectangle rowBounds, int rowIndex, DataGridViewElementStates rowState, bool isFirstDisplayedRow, bool isLastVisibleRow)
        {
            if (this.isGroupRow)
            {
                ...
                group.ItemsText = grid.ItemsText;
                ...
                Font gFont = new Font(grid.Font.FontFamily, grid.Font.Size + 1, FontStyle.Bold);
                ...
                graphics.DrawString(group.Text, gFont, Brushes.Black, rowHeadersWidth - grid.HorizontalScrollingOffset + 24, rowBounds.Bottom - 22);

                //draw bottom line
                graphics.FillRectangle(brush2, rowBounds.Left + rowHeadersWidth - grid.HorizontalScrollingOffset, rowBounds.Bottom - 2, gridwidth, 2);
