...
namespace TPH.LIS.Common.Extensions
{
    ...
    {
        public static string GetSQLErrorMessage(OdbcException exception, string sqlQuery, string userId)
        {
            ...
            ErrorHandler.RecordError(DateTime.Now.ToString("dd/MM/yyyy HH:mm:ss") + ",User: " +
            ...
            frm.Msg = errorMessage;
            frm.ErrDetail = "Error Code: " + errorCode + Environment.NewLine + exception.ToString();
            frm.ShowDialog();
            return errorMessage;
        }

        public static string GetSQLErrorMessage(SqlException exception, string sqlQuery, string userId)
        {
            var errorMessage = string.Empty;
            var errorCode = string.Empty;
            var totalErrors = exception.Errors.Count;
        ...
        public static string GetOdbchisErrorMessage(OdbcException exception, string sqlQuery, bool isTestConnect, string userid)
        {
            ...
            frm.ErrDetail = "Error Code: " + errorCode + Environment.NewLine + exception.ToString();
            frm.ShowDialog();
            ErrorHandler.RecordError(DateTime.Now.ToString("dd/MM/yyyy HH:mm:ss") + ",User: " + userid +
        ...
        public static string GetFrameworkErrorMessage(Exception ex, string methodCall, bool isShow, string userid)
        {
            ...
            ErrorHandler.RecordError(DateTime.Now.ToString("dd/MM/yyyy HH:mm:ss") +
            ...
            if (isShow)
            {
                FrmMessageError frm = new FrmMessageError();
                frm.Msg = errorMessage;
                frm.ErrDetail = Environment.NewLine + "METHOD CALL: " + methodCall +
                                Environment.NewLine + ex.ToString();
                frm.ShowDialog();
            }
            return errorMessage;
