namespace TPH.Lab.Middleware.LISConnect.Services
{
    ...
    public interface IConnectHISService
    {
        ...
        HISReturnBase GetPatientOrderedDetail(HisConnection hisConnect, List<HisFunctionConfig> hisFunction, HisParaGetList paraInfo
            , List<HISDataColumnNames> hisColumns, bool onlyNotGet = false
        ...
        BenhNhanInfoForHIS ParseHisPatientInfo(DataRow drSource
