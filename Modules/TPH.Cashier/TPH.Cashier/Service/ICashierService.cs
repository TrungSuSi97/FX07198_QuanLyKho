...
namespace TPH.Cashier.Service
{
    public interface ICashierService
    {
        ...
        string TaoBienlaiThuTien(string maTiepNhan, List<CashierContanst.CashierItemSelected> lstSelctedItem
        ...
        string TaoBienLaiHoanTien(string maTiepNhan, List<CashierContanst.CashierItemSelected> lstSelctedItem
       , string tenMayTinh, string thuNgan
