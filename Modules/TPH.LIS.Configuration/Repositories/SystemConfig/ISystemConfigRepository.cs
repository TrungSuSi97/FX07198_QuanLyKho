...
namespace TPH.LIS.Configuration.Repositories.SystemConfig
{
    public interface ISystemConfigRepository
    {
        ...
        void InsertUpdateConfiguationDetail(ConfigurationDetail objConfigurationDetail);
        ...
        void AddNewTest(string code, string name, string group, string unit, string normal,
            string lower, string upper, string price, string boldName, string boldResult,
            string mainTest, string criteria, string sampleType, string printNo, string orderNo, bool ignoreCheckResult);
        ...
        void GetTestCaculate(ref SqlDataAdapter da, DataGridView dtg, BindingNavigator bv, string filter, ref DataTable dt);
        ...
        DataTable GetLocation(string makhoaphong, string tenKhoaPhong);
        ...
        DataTable Get_NhomCLS_NoiSoi(ComboBox cbo, string filter, ref DataTable dt);
       ...
       ref DataTable dt);
        ...
        DataTable Get_Data_dm_hentraketqua(CustomComboBox cbo, string _ValueColumn, string _DisplayColumn, string ColumnsName
        ...
        DataTable Data_dm_xetnghiem_bophan_withCategory(string category);
        ...
        DataSet GetApplicationLicense(string computerName, string applicationName, string serial);
        bool CheckExistApplicationLicense(string computerName, string applicationName);
