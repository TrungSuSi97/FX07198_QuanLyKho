...
{
    public interface IMicrobiologyTestResultRepository
    {
        bool Update_ketqua_cls_xetnghiem_visinh_kqViSinh(string maTiepNhan, string maYeuCau, string userUpdate
       ...
       , bool checkDaLayMau, bool checkDaNhanMau, string lstMaNhomPhanQuyen);
        ...
        bool Update_KetQuaViKhuan(string maTiepNhan, string maYeuCau, string maViKhuan, bool mic
            , string ketQuaESBL, string KetQuaBetaLactamases);
        ...
        bool Insert_ketqua_cls_xetnghiem_vikhuan_amtinh(string maTiepNhan, string maYeuCau, string maPhanLoaiViKhuan, string nguoiNhap, string kyThuat, int lanXetnghiem);
        bool Insert_Ketqua_xetnghiem_khangsinhdo_khongvikhuan(string matiepNhan, string maYeuCau, string maVikhuan
