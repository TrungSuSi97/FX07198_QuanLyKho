...
namespace TPH.LIS.TestResult.Services
{
    public interface ITestResultService
    {
        ...
        int CapNhat_BSKyten(string maTiepNhan, string lstMaXn, string BsKyTenMoi, string NguoiThucHien, string PcThucHien, bool CapNhatUpload);
        ...
        bool CapNhatPrintOut_WithReportType(string maTiepnhan, string reportType
            , bool isPrint, string nguoiIn, bool tuXacNhan, string someTestIn, bool xacNhanDe
            , string kyTen, int idLayNguoiThucHien);
        ...
        void Get_CLS_KetQua_XN(DataTable dtInfo, int index, DataGridView dtg, BindingNavigator bv,
        ...
        DataTable DuLieuIn_XN(DataTable dtThongTin, int index, bool layMailTheoBn, string userSign, string xnIn, bool title, DateTime? ngayInKQ
            , string[] userWorkPlace, string reportType, bool reprint, TestType.EnumTestType[] testType, string inCategory, bool TgInDauTien = false, bool sinhHocPhanTu = false
            , string maCaptren = "", bool dulieuIn = false, string inBoPhan = "", bool chiInCoKetQua = false, string userPermision = ""
            , bool huyetDo = false
        ...
        int CapNhat_GhoChu_XNTheoBoPhan(string maTiepNhan, string maBoPhan, string ghiChu, string userNhap);
        ...
        int Update_NhanXetDeNghi_Nhom(string maTiepNhan, string maNhomCLS, string nhanXet, string nguoiNhanXet
