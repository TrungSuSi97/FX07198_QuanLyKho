...
namespace TPH.LIS.Patient.Repositories
{
    public interface IPatientInformationRepository
    {
        ...
        DataTable Data_BenhNhan_TiepNhan(string matiepnhan, string[] condition, string bophanXN = "");
        ...
        DataTable Calculate_TraKetQua(string maTiepNhan, string soHoSo, DateTime? ngayTiepNhan, string barcode, string GioLamViec
            , string GioNghiTrua, string GioLamChieu, string GioNghiChieu, int NghiCuoiTuan, ServiceType[] arrLoaiDichVu, bool traTheoXnNghiem);
