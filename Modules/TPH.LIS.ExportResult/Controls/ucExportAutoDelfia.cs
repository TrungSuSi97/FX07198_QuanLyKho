...
{
    public partial class ucExportAutoDelfia : UserControl
    {
        public ucExportAutoDelfia()
        {
            InitializeComponent();
        }
        ...
        private void btnXuatExcel_Click(object sender, EventArgs e)
        {
            ...
            {
               Excel.ExportToExcel.Export(gvXetNghiemExport, string.Format("XetnghiemAutoDelfia_{0}", DateTime.Now.ToString("ddMMyyyyHHmmss")), null, null, null);
            }
        }
                                ...
                                foreach (DataColumn dtcP in dataResult.Columns)
                                {
                                    if (dtResulbyPatient.Columns.Contains(dtcP.ColumnName))
                                    {
                                        ...
                                        if (dtcP.ColumnName.Equals("hotenme", StringComparison.OrdinalIgnoreCase))
                                        {
                                            ...
                                            drAdd[dtcP.ColumnName] = dtResulbyPatient.Rows[0]["HoTen"].ToString().Replace(tenme, "");
                                        }
        ...
        private void ucExportAutoDelfia_Load(object sender, EventArgs e)
        {
