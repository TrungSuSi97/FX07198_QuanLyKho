...
{
    public partial class ucKetQua_TongHop_GopKetQua_NormalGrid : UserControl
    {
        public ucKetQua_TongHop_GopKetQua_NormalGrid()
        {
            InitializeComponent();
        }
    ...
    int width = 70, int? minWidth = null, int? maxWidth = null, FormatType? formatType = null, string formatString = null, bool groupSummary = false)
        ...
        private void ucKetQua_TongHop_GopKetQua_NormalGrid_Load(object sender, EventArgs e)
        {
