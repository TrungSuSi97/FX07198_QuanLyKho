...
{
    public partial class ucMauXetNghiem_GiaoNhanMau : UserControl
    {
        public ucMauXetNghiem_GiaoNhanMau()
        {
            InitializeComponent();
        }
        ...
        {
           Excel.ExportToExcel.Export(gcCTXN, string.Format("SoGiaoNhanMau_{0}", DateTime.Now.ToString("ddMMyyyyHHmmss")), false, -1, -1, new string[]
        ...
        private void ThongKeChiTietMauXN()
        {
            ...
            var data = _iexport.XuatThongTinMau_SoGiaoNhan(condit);
            if (data != null)
            {
    ...
    int width = 70, int? minWidth = null, int? maxWidth = null, FormatType? formatType = null, string formatString = null, bool groupSummary = false)
        ...
        private void ucMauXetNghiem_GiaoNhanMau_Load(object sender, EventArgs e)
        {
