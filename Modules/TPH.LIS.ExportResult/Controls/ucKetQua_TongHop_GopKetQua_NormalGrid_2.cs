...
{
    public partial class ucKetQua_TongHop_GopKetQua_NormalGrid_2 : UserControl
    {
        public ucKetQua_TongHop_GopKetQua_NormalGrid_2()
        {
            InitializeComponent();
        }
        ...
        private void btnXuatExcel_Click(object sender, EventArgs e)
        {
            ...
            ExportToExcel.Export_NormalDataGrid(dtgResultColumn, new string[] { "Tuổi" }
