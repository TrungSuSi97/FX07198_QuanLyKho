...
{
    public partial class ucMauXetNghiem_SoTuChoiMau : UserControl
    {
        public ucMauXetNghiem_SoTuChoiMau()
        {
            InitializeComponent();
        }
        ...
        {
           ExportToExcel.Export(gcCTXN, string.Format("SoTuChoiMau_{0}", DateTime.Now.ToString("ddMMyyyyHHmmss")), false, -1, -1, new string[]
        ...
        private void ThongKeChiTietMauXN()
        {
            ...
            var data = _iexport.XuatThongTinMau_SoTuChoimau(condit);
            if (data != null)
            {
    ...
    int width = 70, int? minWidth = null, int? maxWidth = null, FormatType? formatType = null, string formatString = null, bool groupSummary = false)
        ...
        private void ucMauXetNghiem_SoTuChoiMau_Load(object sender, EventArgs e)
        {
