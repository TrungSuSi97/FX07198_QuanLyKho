...
{
    public partial class ucKetQua_TongHop_GopKetQua : UserControl
    {
        public ucKetQua_TongHop_GopKetQua()
        {
            InitializeComponent();
        }
    ...
    int width = 70, int? minWidth = null, int? maxWidth = null, FormatType? formatType = null, string formatString = null, bool groupSummary = false)
        ...
        private void ucKetQua_TongHop_GopKetQua_Load(object sender, EventArgs e)
        {
