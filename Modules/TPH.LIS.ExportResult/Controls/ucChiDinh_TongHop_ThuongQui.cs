...
{
    public partial class ucChiDinh_TongHop_ThuongQui : UserControl
    {
        public ucChiDinh_TongHop_ThuongQui()
        {
            InitializeComponent();
        }
    ...
    int width = 70, int? minWidth = null, int? maxWidth = null, FormatType? formatType = null, string formatString = null, bool groupSummary = false)
        ...
        private void ucChiDinh_TongHop_ThuongQui_Load(object sender, EventArgs e)
        {
