    ...
    public sealed class PosgreDb
    {
        ...
        public static int ExecuteNonQuery(string connectionString, string spName, params object[] parameterValues)
        {
            ...
            if ((parameterValues != null) && (parameterValues.Length > 0))
            {
                ...
                NpgsqlParameter[] commandParameters = PosgreNpgsqlParameterCache.GetSpParameterSet(connectionString, spName);
        ...
        public static int ExecuteNonQuery(NpgsqlConnection connection, string spName, params object[] parameterValues)
        {
            ...
            {
                // Pull the parameters for this stored procedure from the parameter cache (or discover them & populate the cache)
                NpgsqlParameter[] commandParameters = PosgreNpgsqlParameterCache.GetSpParameterSet(connection, spName);
        ...
        public static int ExecuteNonQuery(NpgsqlTransaction transaction, string spName, params object[] parameterValues)
        {
            ...
            {
                // Pull the parameters for this stored procedure from the parameter cache (or discover them & populate the cache)
                NpgsqlParameter[] commandParameters = PosgreNpgsqlParameterCache.GetSpParameterSet(transaction.Connection, spName);
