...
{
    public partial class FrmBaoCaoDoanhThu_bk : FrmTemplate
    {
        public FrmBaoCaoDoanhThu_bk()
        {
            InitializeComponent();
        }
        ...
        private void Load_DanhSachThuNgan()
        {
            ...
            user.Get_UserSign(cboThuNgan, ServiceType.ThuNgan, " and d.MaNguoiDung not in ('admin')");
        ...
        {
            C_NguoiDung user = new C_NguoiDung();
            user.Get_UserSign(cboDSKetChuyenThuNgan, ServiceType.ThuNgan, " and d.MaNguoiDung not in ('admin')");
