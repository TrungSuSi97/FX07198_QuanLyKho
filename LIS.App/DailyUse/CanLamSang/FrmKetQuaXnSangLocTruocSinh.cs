...
{
    public partial class FrmKetQuaXnSangLocTruocSinh : FrmTemplate
    {
        ...
        public FrmKetQuaXnSangLocTruocSinh()
        {
            InitializeComponent();
        ...
        private void ClearControl()
        {
            ...
            dtpNgaySinhTruoc.Value = DateTime.Now;
            dtpNgaySinhTruoc.Checked = false;
        ...
        private void SetDataInformation(BENHNHAN_TIEPNHAN objTiepNhan, BENHNHAN_MAUSANGLOC objSangLoc)
        {
            ...
            txtDiaChi.Text = objTiepNhan.Diachi;
            ...
            txtNhanXet.Text = objSangLoc.NhanXetSangLoc;
            txtDeNghi.Text = objSangLoc.DeNghiSangLoc;
            txtKetLuan.Text = objSangLoc.KetLuanSangLoc;
            ...
            dtpNgaySinhTruoc.Value = objSangLoc.Ngaysinhtruoc ?? DateTime.Now;
            dtpNgaySinhTruoc.Checked = objSangLoc.Ngaysinhtruoc == null ? false : true;
            numTuoiThaiSinhTruoc.Value = objSangLoc.Tuoithaisinhtruoc;
            chkSinhT21T18T13.Checked = objSangLoc.Sinhcont21t18t13;

            if (objSangLoc.Ngaysieuam != null)
                dtpNgaySieuAm.Value = objSangLoc.Ngaysieuam.Value;
        }
        ...
        private bool CheckInThuongQuy(bool print, string maureportChon, bool byList)
        {
            ...
            if (ucKetQuaThuongQuy1.InKetQua(print, userSign, printerName, false, false
                , chkChiInCoKetQua.Checked, progressPrint, maureportChon, string.Empty
                , string.Empty, (dtpNgayInKQ.Checked ? dtpNgayInKQ.Value : (DateTime?)null), true))
            {
                if (!byList)
                {
