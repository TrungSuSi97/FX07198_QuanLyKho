...
{
    public partial class ucSearchLookupEditor_Lydo : UserControl
    {
        private readonly ISystemConfigService sysConfig = new SystemConfigService();
        public ucSearchLookupEditor_Lydo()
        {
            InitializeComponent();
        ...
        {
            if (gvLydo.RowCount == 1 && !string.IsNullOrEmpty(txtFind.Text))
            {
                gvLydo.FocusedRowHandle = 0;
                lueGioiTinh.ClosePopup();
            }
        }
        ...
        public void Load_GioiTinh()
        {
            ...
            lueGioiTinh.Properties.DisplayMember = "Value";
            lueGioiTinh.Properties.AutoHeight = false;
