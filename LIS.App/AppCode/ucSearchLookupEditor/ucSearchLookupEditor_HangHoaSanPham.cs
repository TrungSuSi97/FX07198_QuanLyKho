...
{
    public partial class ucSearchLookupEditor_HangHoaSanPham : UserControl
    {
        ...
        public ucSearchLookupEditor_HangHoaSanPham()
        {
            InitializeComponent();
        ...
        public void Load_SanPham(string itemcode, string madanhmuc)
        {
            if (EditValueChanged != null)
                lueNhanVien.EditValueChanged -= EditValueChanged;
            var data = _iProduct.GetItems(new ItemModel() { ItemCode = itemcode, MaDanhMuc = madanhmuc });
            lueNhanVien.Properties.DataSource = data;
            lueNhanVien.Properties.ValueMember = "ItemCode";
            lueNhanVien.Properties.DisplayMember = "ItemName";
            lueNhanVien.Properties.PopupFormMinSize = new Size(300, 200);
            lueNhanVien.Properties.AutoHeight = false;
            lueNhanVien.Properties.BestFitMode = DevExpress.XtraEditors.Controls.BestFitMode.BestFitResizePopup;
            if (EditValueChanged != null)
        ...
        public void Load_Thang()
        {
            if (EditValueChanged != null)
                lueNhanVien.EditValueChanged -= EditValueChanged;
            var data = DataTable_Thang();
            lueNhanVien.Properties.DataSource = data;
            lueNhanVien.Properties.ValueMember = "MaThang";
            lueNhanVien.Properties.DisplayMember = "MaThang";
            lueNhanVien.Properties.PopupFormMinSize = new Size(300, 200);
            lueNhanVien.Properties.AutoHeight = false;
            lueNhanVien.Properties.BestFitMode = DevExpress.XtraEditors.Controls.BestFitMode.BestFitResizePopup;
            if (EditValueChanged != null)
        ...
        private DataTable DataTable_Thang()
        {
            // Create a DataTable
        ...
        public void Load_DanhMucHH()
        {
            if (EditValueChanged != null)
                lueNhanVien.EditValueChanged -= EditValueChanged;
            var data = _iProduct.GetDMHH(string.Empty);
            lueNhanVien.Properties.DataSource = data;
            lueNhanVien.Properties.ValueMember = "MaDanhMuc";
            lueNhanVien.Properties.DisplayMember = "TenDanhMuc";
            lueNhanVien.Properties.PopupFormMinSize = new Size(300, 200);
            lueNhanVien.Properties.AutoHeight = false;
            lueNhanVien.Properties.BestFitMode = DevExpress.XtraEditors.Controls.BestFitMode.BestFitResizePopup;
            if (EditValueChanged != null)
