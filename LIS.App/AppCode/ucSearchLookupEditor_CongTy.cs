...
{
    public partial class ucSearchLookupEditor_CongTy : UserControl
    {
        private readonly ISystemConfigService sysConfig = new SystemConfigService();
        public ucSearchLookupEditor_CongTy()
        {
            InitializeComponent();
        ...
        {
            gcLueId.FieldName = ControlExtension.PropertyNameToLowerCase<DM_CONGTY>(x => x.Macongty);
            gcLueId.Caption = ControlExtension.GetDescription<DM_CONGTY>(x => x.Macongty);
            gcLueName.FieldName = ControlExtension.PropertyNameToLowerCase<DM_CONGTY>(x => x.Tencongty);
            gcLueName.Caption = ControlExtension.GetDescription<DM_CONGTY>(x => x.Tencongty);
            var data = sysConfig.Data_dm_congty(string.Empty);
            lueDanhSach.Properties.DataSource = WorkingServices.ConvertColumnNameToLower_Upper(data, true);
            lueDanhSach.Properties.ValueMember = ControlExtension.PropertyNameToLowerCase<DM_CONGTY>(x => x.Macongty);
            lueDanhSach.Properties.DisplayMember = ControlExtension.PropertyNameToLowerCase<DM_CONGTY>(x => x.Tencongty);
