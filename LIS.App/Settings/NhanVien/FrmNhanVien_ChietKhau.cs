...
namespace TPH.LIS.App.CauHinh.NhanVien
{
    public partial class FrmNhanVien_ChietKhau : FrmTemplate
    {
        ...
        {
            LabServices_Helper.Filter_BindingSource(dtgDNhanVien, bvDNhanVien, _dtNhanVien, "TenNhanVien", txtTenBacSi.Text);
        }

        private void radKhamBenh_Click(object sender, EventArgs e)
        {
            txtTenBacSi.Text = string.Empty;
            LabServices_Helper.Filter_BindingSource(dtgDNhanVien, bvDNhanVien, _dtNhanVien, "KhamChuaBenh", true);
        }

        private void radGui_Click(object sender, EventArgs e)
        {
            txtTenBacSi.Text = string.Empty;
            LabServices_Helper.Filter_BindingSource(dtgDNhanVien, bvDNhanVien, _dtNhanVien, "GuiChiDinh", true);
        }
        ...
        private void txtTenDichVu_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            LabServices_Helper.Filter_BindingSource(dtgChietKhau, 
                bvChietKhau, 
                _dtChietKhau,
                "tendichvu", 
                txtTenDichVu.Text);
